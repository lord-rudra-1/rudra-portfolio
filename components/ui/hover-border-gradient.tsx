...
export const HoverBorderGradient = forwardRef<HTMLDivElement, HoverBorderGradientProps>(
  ({ children, containerClassName, className, duration = 1, clockwise = true, ...props }, ref) => {
    ...
    const highlight = "radial-gradient(75% 181.15942028985506% at 50% 50%, rgba(168, 85, 247, 0.8) 0%, rgba(236, 72, 153, 0.8) 50%, rgba(255, 255, 255, 0) 100%)"
